...
def send_request(domain:str, url:str, akamai_headers:dict, request_cookies:dict)->dict:
        """
        ...
        try:
            ...
            response = requests.get(f"https://{domain}{url}", headers=akamai_headers, cookies=request_cookies,timeout=30)
